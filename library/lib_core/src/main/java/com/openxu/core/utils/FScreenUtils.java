...
public final class FScreenUtils {
    ...
    public static boolean isLandscape() {
        return FUtils.getApp().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) FUtils.getApp().getSystemService(Context.KEYGUARD_SERVICE);
        //noinspection ConstantConditions
    ...
    public static boolean isTablet() {
        return (FUtils.getApp().getResources().getConfiguration().screenLayout
