...
public final class FActivityUtils {

    private FActivityUtils() {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(FUtils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(FUtils.getApp().getPackageManager()) == null ||
                FUtils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = FUtils.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(FUtils.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(FUtils.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(FUtils.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(FUtils.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, FUtils.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @NonNull final Bundle options) {
        return startActivity(intent, FUtils.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, FUtils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, FUtils.getTopActivityOrApp(), options);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(FUtils.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String pkg) {
        ...
        PackageManager pm = FUtils.getApp().getPackageManager();
    ...
    public static Activity getTopActivity() {
        return FUtils.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = FUtils.getActivityList();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = FUtils.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(FUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(FUtils.getApp(), clz));
    }
