...
//    这里应该是获取的下载的速度
    ...
    public static boolean isAvailableByPing(String ip) {
        ...
        FShellUtils.CommandResult result = FShellUtils.execCmd(String.format("ping -c 1 %s", ip), false);
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) FUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) FUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) FUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int obtainWifiLevel(int numLevels) {
        // Wifi的连接速度及信号强度：
        WifiManager wifiManager = (WifiManager) FUtils.getApp().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) FUtils.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
